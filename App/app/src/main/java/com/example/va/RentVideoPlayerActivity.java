...
public class RentVideoPlayerActivity extends BaseActivity {

    public static final String VIDEO_URL_EXTRA = "video_link";
    public static final String VIDEO_ID_EXTRA = "video_id";
    public static final String VIDEO_NAME_EXTRA = "video_name";
    public static final String THUMBNAIL_LINK_EXTRA = "th_link";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_video_player);
