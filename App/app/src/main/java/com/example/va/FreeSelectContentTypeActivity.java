...
public class FreeSelectContentTypeActivity extends AppCompatActivity {
    ...
    private void openVideoListActivity(String contentType) {
        Intent intent = new Intent(FreeSelectContentTypeActivity.this, VideoListActivity.class);
